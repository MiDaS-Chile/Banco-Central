...
- La BBDD `neverhpfilter::GDPC1` contiene la serie del PIB real de USA 
entre 1947Q1 y 2017Q3. Carguemos la serie y pasémosla a escala logarítmica
```{r}
...
- El archivo `Seatbelt.txt` contiene la serie mensual del número de conductores mensualmente muertos o heridos en accidente de tránsito en Gran Bretaña, entre enero de 1969 y Diciembre de 1984. Dado lo anterior:
