...
<p align = "justify"> Sea \(\bar{X}_n = \frac{1}{n}\sum_{i=1}^n X_i\) donde los \(X_i\) son variables aleatorias independientes e idénticamente distribuidas con $E(X_i \ ) = \mu, \text{var}(X_i \ ) = \sigma^2$. La ley de los grandes números nos dice que </p> $$\bar{X}_n \xrightarrow{P} \mu.$$ 
...
<p align = "justify"> Un intervalo de confianza contendrá un 95% de las veces el verdadero real del parámetro. En este [enlace](https://istats.shinyapps.io/ExploreCoverage/) se puede observar cómo se comportan los intervalos de confianza </p>
...
Transformamos libras a kilogramos
...
<p align = "justify"> Los siguientes corresponden a algoritmos implementados en `R` para la selección de variables </p>
