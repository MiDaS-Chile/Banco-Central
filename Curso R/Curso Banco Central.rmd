...
# Conceptos Basicos de R{ .center .white data-background="#75AADB" }

## Descarga e Instalación

- R se descarga desde un repositorio llamado [CRAN](http://cran.r-project.org). Se debe elegir la opción que corresponda con el sistema operativo.
