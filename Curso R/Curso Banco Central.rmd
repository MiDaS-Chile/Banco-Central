...
- R se descarga desde un repositorio llamado [CRAN](http://cran.r-project.org). Se debe elegir la versión que corresponda al sistema operativo.
- RStudio, el panel de control, se descarga desde su página oficial [http://www.rstudio.com](http://www.rstudio.com). Elegir la primera opción, "RStudio Desktop Open Source License". 
...
<p align = "left"> Una herramienta para la manipulación de objetos son las funciones. Una función en `R` tiene la estructura de `nombre_funcion(<lista de argumentos>)`. </p> 

<p align = "left"> Para asignar el valor de un argumento existen dos opciones: </p> 

- `funcion(nombre_argumento1 = argumento1, nombre_argumento2 = argumento2)` 
- `funcion(valor_argumento1, argumento_2)`

<p align = "justify">
**Importante:** En el segundo caso es necesario asignar los valores en el orden preestablecido por la función. Para averiguar dicho orden, así como el funcionamiento de una función, se debe hacer `?nombre_funcion()`. </p>
...
Para más información, pueden entrar al siguiente [sitio web.](https://resources.rstudio.com/spanish-pdfs/data-import-cheatsheet-spanish).

## Ejemplo: storms.csv

La base de datos storms se encuentra en el siguiente [url](https://raw.githubusercontent.com/rstudio/EDAWR/master/data-raw/storms.csv).
...
<p align = "justify">
Permite ordenar de menor a mayor una BD teniendo en consideración una o más variables. </p>
