...
- Para R, una función es un objeto específico.
- Por lo tanto, crear una función corresponde a asignar el objeto "función R"
a una variable, cuyo nombre corresponde a la función misma.
...
Para que esta función se ejecute, el usuario debe llamar a la función,
seguido del argumento entre paréntesis.
</p>
```{r}
hello("Peter")
```
